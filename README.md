...
Not demos — production-ready agents that actually work.
...
💬 **LLM Chatbots** — with memory, personality & context awareness  
🔄 **Automation Pipelines** — news monitoring, research, data extraction  
🌐 **AI Web Apps** — Flask + dark UI + real-time response  
...
|---|---|
| [🧠 NEXUS AI Agent](https://github.com/ahmadnazzal22/nexus-ai-agent) | Autonomous multi-tool agent — search, code & files |
| [📄 Document Q&A](https://github.com/ahmadnazzal22/document_qa_agent) | Upload any PDF — ask anything, get exact answers |
| [📰 AI News Agent](https://github.com/ahmadnazzal22/ai-news-agent) | Real-time news monitoring with AI summaries |
| [▶️ YouTube Summarizer](https://github.com/ahmadnazzal22/youtube-summarizer) | Turn any video into structured AI notes |
